...
public class Ex03_Busca_Binaria {
	...
	public static void main(String[] args) {
		    ...
		    // Enquanto a posição do inicio for menor ou igual a posição do fim,procura o valor de x dentro do vetor. 
		    while(inicio <= fim) {
		    	meio = (fim + inicio) / 2; //Encontra o meio do vetor.
		      
		      	System.out.println("Inicio: " + numeros[inicio] + " - Meio: " + numeros[meio] + " - Fim: " + numeros[fim]);
		     
		      	// Se o valor que está no meio do vetor é igual ao valor procurado, imprime que encontrou o valor e para de pesquisar. 
		      	if(numeros[meio] == x) {
		    	  ...
		    	  // Se o valor que está no meio do vetor for maior que o valor de x, então o fim do vetor será igual a posição do meio - 1. 
		    	  fim = meio - 1;
		      	}
